...
public class FunctionDeclarePart {
    ...
    public FunctionDeclarePart(String assignTarget, VariantManager variants, Position position) {
        this(variants.assignVar(assignTarget, position), variants, position);
    }

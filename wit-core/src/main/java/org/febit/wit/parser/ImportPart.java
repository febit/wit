...
public class ImportPart {
    ...
    public ImportPart(Expression pathExpr, @Nullable Expression paramsExpr, Position position) {
        this.position = position;
        this.pathExpr = AstUtils.optimize(pathExpr);
    ...
    public Import pop(Script script) {
        ...
        return len == 0
                ? new Import(pathExpr, paramsExpr, null, null, refer, position)
                : new Import(pathExpr, paramsExpr,

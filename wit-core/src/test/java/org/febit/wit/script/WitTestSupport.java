...
import org.febit.wit.script.component.TestCasesModule;
import org.febit.wit.script.component.TestConfigFlagModule;
import org.febit.wit.script.component.TestSpiFlagModule;
...
public class WitTestSupport {
    ...
    public static final Wit WIT = Wit.builder()
            ...
            .setup(
                    ...
                    "cases:/lib/global.init.wit",
                    "cases:/lib/global.init2.wit",
                    "cases:/lib/local.init.wit"
            )
            .build();
    ...
    static Loader loader() {
        ...
        var fixtures = Loaders.classpath()
                .root("org/febit/wit/scripts/fixtures")
                .beginWith(Source.BeginWith.SCRIPT)
                .candidateSuffixes(EXT_DEPUTIES)
                .completeMissingSuffix(EXT_WIT)
                .build();

        var cases = Loaders.classpath()
                .root("org/febit/wit/scripts/cases")
                .build();
        ...
        var lib = Loaders.classpath()
                .root("org/febit/wit/scripts/lib")
                .beginWith(Source.BeginWith.SCRIPT)
                .candidateSuffixes(EXT_DEPUTIES)
                .completeMissingSuffix(EXT_WIT)
                .build();
        ...
        var libSub = Loaders.classpath()
                .root("org/febit/wit/scripts/lib-sub")
                .beginWith(Source.BeginWith.SCRIPT)
                .candidateSuffixes(EXT_DEPUTIES)
                .completeMissingSuffix(EXT_WIT)
                .build();
        ...
        var lazyLoader = Loaders.debouncing(fixtures, Duration.ofSeconds(10));

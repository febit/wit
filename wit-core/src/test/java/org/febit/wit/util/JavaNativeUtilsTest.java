...
class JavaNativeUtilsTest {
    ...
    protected Constructor matchConstructor(Class... classes) {
        return JavaNativeUtils.getMatchConstructor(Methods.class.getConstructors(), classes);
    }

    protected Method matchFoo(Class... classes) {
        return JavaNativeUtils.getMatchMethod(fooMethods, classes);
    }

    protected Method matchMix(Class... classes) {
        return JavaNativeUtils.getMatchMethod(mixMethods, classes, true);
    }

    protected Method getMatchMethod(Method[] methods, Class... classes) {
        return JavaNativeUtils.getMatchMethod(methods, classes);
    }

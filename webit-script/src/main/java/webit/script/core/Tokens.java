...
public interface Tokens {
    ...
    public static final int MINUSGT = 68;
    ...
    public static final int TEXT_STATEMENT = 73;
    public static final int DIRECT_VALUE = 74;
    public static final int CONST = 75;

    /* non terminals */
//    static final int classPureName = 0;
//    static final int className = 1;
//    static final int templateAST = 2;
//    static final int statementList = 3;
//    static final int statement = 4;
//    static final int ifStat = 5;
//    static final int block = 6;
//    static final int caseBlockStat = 7;
//    static final int varPart = 8;
//    static final int varAssign = 9;
//    static final int importPart1 = 10;
//    static final int importPart2 = 11;
//    static final int blockPrepare = 12;
//    static final int blockPrepare2 = 13;
//    static final int switchPart = 14;
//    static final int switchPart0 = 15;
//    static final int forInHead = 16;
//    static final int forInBody = 17;
//    static final int forInPart = 18;
//    static final int whilePart = 19;
//    static final int ifPart = 20;
//    static final int expression = 21;
//    static final int expression_statementable = 22;
//    static final int expressionList = 23;
//    static final int expressionList1 = 24;
//    static final int mapValuePart = 25;
//    static final int mapValue = 26;
//    static final int contextValueIdent = 27;
//    static final int superCount = 28;
//    static final int contextValueExpr = 29;
//    static final int classNameList = 30;
//    static final int classNameList1 = 31;
//    static final int funcExecuteExpr = 32;
//    static final int funcHeadPrepare = 33;
//    static final int funcHead = 34;
//    static final int funcStatementHeadPrepare = 35;
//    static final int funcStatementHead = 36;
//    static final int lambaExpr = 37;
//    static final int lambaExprHead = 38;
}

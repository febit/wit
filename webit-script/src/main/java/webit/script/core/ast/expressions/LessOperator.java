 ...
 * @author Zqq
 */
public final class LessOperator extends BinaryOperator implements Optimizable {

    public LessOperator(Expression leftExpr, Expression rightExpr, int line, int column) {

 ...
 * @author Zqq
 */
public final class MinusMinusBeforeOperator extends AbstractExpression {

    private final ResetableValueExpression expr;

    public MinusMinusBeforeOperator(ResetableValueExpression expr, int line, int column) {
        super(line, column);
        this.expr = expr;
    }

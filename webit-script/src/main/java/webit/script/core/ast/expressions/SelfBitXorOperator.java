 ...
 * @author Zqq
 */
public final class SelfBitXorOperator extends SelfOperator{

    public SelfBitXorOperator(ResetableValueExpression leftExp, Expression rightExp, int line, int column) {

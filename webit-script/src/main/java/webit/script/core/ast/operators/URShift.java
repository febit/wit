 ...
 * @author Zqq
 */
public final class URShift extends BinaryOperator implements Optimizable {

    public URShift(Expression leftExpr, Expression rightExpr, int line, int column) {
        super(leftExpr, rightExpr, line, column);
    }

    public Object execute(final Context context) {
        return ALU.urshift(StatementUtil.execute(leftExpr, context), StatementUtil.execute(rightExpr, context));
    }

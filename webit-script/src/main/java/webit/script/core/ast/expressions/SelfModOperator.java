 ...
 * @author Zqq
 */
public final class SelfModOperator extends SelfOperator{

    public SelfModOperator(ResetableValueExpression leftExp, Expression rightExp, int line, int column) {

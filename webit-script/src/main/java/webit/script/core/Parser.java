...
/** CUP v0.12for-WebitScript-only generated parser.
  * @version Sun Dec 22 17:01:51 CST 2013
  */
public class Parser extends lr_parser {
  ...
  final static int START_STATE = 0;
    ...
    private Expression createNativeStaticValue(ClassNameBand classNameBand, int line, int column) {
        ...
        return this.nativeFactory.createNativeStaticValue(nativeImportMgr.toClass(classNameBand, line, column), fieldName, line, column);
    }
  ...
  final Object do_action(int actionId) throws ParseException {
	...
	{
		 return ((FunctionDeclarePart) myStack.peek(3).value).pop(varmgr, (StatementList) myStack.peek(1).value); 
	}

	case 107: // expression ::= funcHead RPAREN LBRACE statementList RBRACE 
	{
		 return ((FunctionDeclarePart) myStack.peek(4).value).pop(varmgr, (StatementList) myStack.peek(1).value); 
	}

	case 105: // expression ::= funcHeadPrepare LPAREN RPAREN LBRACE statementList RBRACE 
	{
		 return ((FunctionDeclarePart) myStack.peek(5).value).pop(varmgr, (StatementList) myStack.peek(1).value); 
	}
	...
	case 109: // expression ::= NATIVE LBRACK RBRACK className 
	{
		Symbol sym$Symbol = myStack.peek(3);
		Symbol nameBand$Symbol = myStack.peek(0);
		 return this.nativeFactory.createNativeNewArrayDeclare(nativeImportMgr.toClass((ClassNameBand) nameBand$Symbol.value, nameBand$Symbol.line, nameBand$Symbol.column), sym$Symbol.line, sym$Symbol.column); 
	}
	...
	case 113: // expression ::= NATIVE NEW classPureName LPAREN classNameList RPAREN 
	{
		...
		Symbol nameBand$Symbol = myStack.peek(3);
		 return this.nativeFactory.createNativeConstructorDeclare(nativeImportMgr.toClass((ClassNameBand) nameBand$Symbol.value, nameBand$Symbol.line, nameBand$Symbol.column), (ClassNameList) myStack.peek(1).value, sym$Symbol.line, sym$Symbol.column); 
	}
	...
	case 111: // expression ::= NATIVE classPureName DOT IDENTIFIER LPAREN classNameList RPAREN 
	{
		...
		Symbol nameBand$Symbol = myStack.peek(5);
		 return this.nativeFactory.createNativeMethodDeclare(nativeImportMgr.toClass((ClassNameBand) nameBand$Symbol.value, nameBand$Symbol.line, nameBand$Symbol.column), (String) myStack.peek(3).value, (ClassNameList) myStack.peek(1).value, sym$Symbol.line, sym$Symbol.column); 
	}

...
/** CUP v0.12for-WebitScript-only generated parser.
  * @version Sat Oct 26 14:29:12 CST 2013
  */
public class Parser extends lr_parser {
  ...
  final Object do_action(int actionId) throws ParseException {
	...
	case 119: // expressionList1 ::= expressionList1 COMMA expression 
	{
	...
	case 134: // classNameList ::= classNameList1 
	{
	...
	case 121: // expressionList ::= expressionList1 
	{
	...
	case 129: // funcExecuteExpr ::= expression LPAREN expressionList RPAREN 
	{
	...
	case 130: // funcExecuteExpr ::= expression AT contextValueExpr LPAREN expressionList RPAREN 
	{
		Symbol funcExpr$Symbol = myStack.peek(3);
	...
	case 126: // funcHead ::= funcHeadPrepare IDENTIFIER 
	{
	...
	case 127: // funcHead ::= funcHead COMMA IDENTIFIER 
	{
		Symbol ident$Symbol = myStack.peek(0);
	...
	case 64: // expression_statmentable ::= VAR IDENTIFIER EQ expression 
	{
		...
		Symbol sym$Symbol = myStack.peek(1);
		 return new AssignOperator(new CurrentContextValue(varmgr.assignVariant((String) ident$Symbol.value,ident$Symbol.line,ident$Symbol.column),(String) ident$Symbol.value,ident$Symbol.line,ident$Symbol.column), (Expression) myStack.peek(0).value, sym$Symbol.line, sym$Symbol.column); 
	}

	case 132: // classNameList1 ::= classNameList1 COMMA className 
	{
	...
	case 131: // classNameList1 ::= className 
	{
		Symbol nameBand$Symbol = myStack.peek(0);
	...
	case 125: // mapValue ::= LBRACE RBRACE 
	{
		Symbol sym$Symbol = myStack.peek(1);
	...
	case 128: // funcHeadPrepare ::= FUNCTION LPAREN 
	{
		Symbol sym$Symbol = myStack.peek(1);

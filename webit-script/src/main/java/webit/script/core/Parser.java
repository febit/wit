...
/** CUP v0.12for-WebitScript-only generated parser.
  * @version Wed Dec 11 17:12:14 CST 2013
  */
public class Parser extends lr_parser {
  ...
  final Object do_action(int actionId) throws ParseException {
	...
	{
		 return ((ImportStatmentPart) myStack.peek(3).value).append((String) myStack.peek(0).value, (Expression) myStack.peek(2).value); 
	}

	case 43: // importStatPart2 ::= importStatPart2 COMMA contextValueExpr EQ IDENTIFIER 
	{
		 return ((ImportStatmentPart) myStack.peek(4).value).append((String) myStack.peek(0).value, (Expression) myStack.peek(2).value); 
	}
	...
	case 133: // funcExecuteExpr ::= expression AT contextValueExpr LPAREN expressionList RPAREN 
	{
		Symbol funcExpr$Symbol = myStack.peek(3);
		 return new FunctionExecuteExpression((Expression) funcExpr$Symbol.value, ((ExpressionList) myStack.peek(1).value).addFirst((Expression) myStack.peek(5).value).toArray(), funcExpr$Symbol.line, funcExpr$Symbol.column); 
	}

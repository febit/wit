...
class StringTemplateParser {
     ...
     * <code>true</code> by default. If
     * <code>false</code> missing keys will be left as it were, i.e. they will
     * not be replaced.
     */
    ...
    /**
     * Specifies replacement for missing keys. If
     * <code>null</code> exception will be thrown.
     */
    ...
    public static MacroResolver createMapMacroResolver(final Map map) {
        return new MacroResolver() {
            public String resolve(String macroName) {
                Object value;
                return (value = map.get(macroName)) != null
                        ? value.toString()
                        : null;
            }
        };
